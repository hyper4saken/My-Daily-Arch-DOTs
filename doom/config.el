...
(after! org
  (setq org-directory "/mnt/Backup/Org/"
        ...
        org-todo-keywords        ; This overwrites the default Doom org-todo-keywords
          '((sequence
             "TODO(t)"           ; A task that is ready to be tackled "BLOG(b)"           ; Blog writing assignments "GYM(g)"            ; Things to accomplish at the gym
...
(after! org
  (setq org-roam-directory "/mnt/DATA/Roam/" org-roam-graph-viewer "/usr/bin/brave")
        (set-face-attribute 'org-level-1 nil :font "JetBrains Mono" :weight 'bold :height 1.8)
        (set-face-attribute 'org-level-2 nil :font "JetBrains Mono" :weight 'bold :height 1.6)
        (set-face-attribute 'org-level-3 nil :font "JetBrains Mono" :weight 'bold :height 1.3)
        (set-face-attribute 'org-level-4 nil :font "JetBrains Mono" :weight 'bold :height 1.1)
        (set-face-attribute 'org-level-5 nil :font "JetBrains Mono" :weight 'bold :height 1.0))
...
(setq org-download-method 'custom)
(setq org-download-custom-functions
      '(("h" . (lambda () (org-download--dir (org-get-title t t t t))))))
...
;; open org file header folded on startup open
